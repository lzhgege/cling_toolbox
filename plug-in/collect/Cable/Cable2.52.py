...
if mc.window("Cable 2.52", exists =True):
    mc.deleteUI("Cable 2.52")

if mc.workspaceControl("Cable 2.52", exists =True):
    mc.deleteUI("Cable 2.52")
...
def createCustomWorkspaceControlCable(*args):
    ...
    cH1b = mc.columnLayout(adj =True)
    frameEdit = mc.frameLayout(l = "Curves Presets", cll =1, cl =1, bgc= [0.15, 0.15, 0.15])
    mc.separator(h= 1, style = 'none')
    mc.rowColumnLayout (  numberOfColumns=6, columnWidth=[ (1,49), (2,49), (3,49), (4,49), (5,45), (6,45) ] )
    scriptFolderPath = r"D:/Cling_toolbox/plug-in/collect/Cable/Cable_script"
    PresetIcon1 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/Preset01.png"
    PresetIcon2 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/Preset02.png"
    PresetIcon3 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/Preset03.png"
    PresetIcon4 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/Preset04.png"
    PresetIcon5 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/Preset05.png"
    PresetIcon6 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/Preset06.png"
    
    preset1 = mc.symbolButton( image= PresetIcon3, c= "Preset01()", ann= "Curve Preset 1")
    preset2 = mc.symbolButton( image= PresetIcon2, c= "Preset02()", ann= "Curve Preset 2")
    preset3 = mc.symbolButton( image= PresetIcon4, c= "Preset03()", ann= "Curve Preset 3")
    preset4 = mc.symbolButton( image= PresetIcon5, c= "Preset04()", ann= "Curve Preset 4")
    preset5 = mc.symbolButton( image= PresetIcon6, c= "Preset05()", ann= "Curve Preset 5")
    preset6 = mc.symbolButton( image= PresetIcon1, c= "Preset06()", ann= "Curve Preset 6")
    ...
    slideScale = mc.floatSliderGrp('Slider_Scale', l = "Scale",min =0.1, max =100,po =True, field =True, cc="Scale_Val()", dc="Scale_Val()", v= 100, adj =0, cat= [1, "left", 3], cw= [1, 60], ann= "Configure to scene set in cm")
    ...
    #_________________________________________________________________________________________________________________MATERIALS
    cH8 = mc.columnLayout(adj =True)
    frameConvert = mc.frameLayout(l = "MATERIALS", cll =1, cl =1, bgc= [0.15, 0.15, 0.15])

    mc.rowColumnLayout (  numberOfColumns=6, columnWidth=[ (1,60), (2,20), (3,50), (4,50), (5,50), (6,50) ] )

    imageDisp = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/Displace_btn.png"
    imageMat1 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/MatA.png"
    imageMat2 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/MatB.png"
    imageMat3 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/MatC.png"
    imageMat4 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/MatD.png"
    imageMat5 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/MatE.png"
    imageMat6 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/MatF.png"
    imageMat7 = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/MatG.png"


    Disp = mc.symbolButton( image= imageDisp, c= "Disp()", ann= "Activate Displace Viewport")
    mc.separator(h= 10, style = 'in', hr= False)
    Mat1 = mc.symbolButton( image= imageMat1, c= "PShiny()", ann= "Shader great for Cable")
    mc.popupMenu()
    mc.menuItem(l= 'Create New One', c= 'cn_PShiny()')
    Mat2 = mc.symbolButton( image= imageMat2, c= "Tresse()", ann= "Shader great for Cable")
    Mat3 = mc.symbolButton( image= imageMat3, c= "Velcro()", ann= "Shader great for Cable")
    Mat4 = mc.symbolButton( image= imageMat4, c= "Cable()", ann= "Shader great for Cable")
    
    mc.setParent( '..' )
    mc.separator (w = 4, style = 'in') 
    mc.rowColumnLayout (  numberOfColumns=6, columnWidth=[ (1,90), (2,90), (3,90), (4,100), (5,100), (6,100) ] )
    Mat5 = mc.symbolButton( image= imageMat5, c= "StripeA()", ann= "Shader great for Cable")
    mc.popupMenu()
    mc.menuItem(l= 'Create New One', c= 'cn_PShiny()')
    Mat6 = mc.symbolButton( image= imageMat6, c= "StripeA()", ann= "Shader great for Cable")
    mc.popupMenu()
    mc.menuItem(l= 'Create New One', c= 'cn_PShiny()')
    Mat7 = mc.symbolButton( image= imageMat7, c= "StripeA()", ann= "Shader great for Cable")
    mc.popupMenu()
    mc.menuItem(l= 'Create New One', c= 'cn_PShiny()')
...
#_________________________________________________________________________________________________________________HELP&INFO
    ...
    frameConvert = mc.frameLayout(l = "Help & Info", cll =1, cl =1, bgc= [0.15, 0.15, 0.15])

    DiscordIcon = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/Discord.png"
    WzxIcon = mc.internalVar(upd = True)+"scripts/Cable_script/Icons/Wzx.png"
    
    mc.separator(h= 1, style = 'none')
    Discord = mc.symbolButton( image= DiscordIcon, c= "DiscordLink()", ann= "Help about Cable on the Disord")
    mc.separator(h= 8, style = 'none')
    WzxStore = mc.symbolButton( image= WzxIcon, c= "WzxStoreLink()", ann= "Other Scripts and Tutorials on the WzxStore")

    mc.setParent( '..' )
    

mc.workspaceControl("Cable 2.52", retain=False, floating=True, uiScript="createCustomWorkspaceControlCable()");
