...
class paintContext (object):
    ...
    def __init__(self, uioptions, transformoptions, sourcelist, targetlist, radius):
        ...
        print('     uiValues', uioptions)
        print('     transform', transformoptions)
        print('     sourceList', sourcelist)
        print('     targetList', targetlist)
        print('     radiusOptions', radius)
    ...
    def runContext(self):
        ...
        '''
        print("paintContext - runContext running...")
        print("     setToolTo(spPaint3dContextID)")
    ...
    def onPress(self):
        ...
        print("entered paintContext onPress")
        ...
        if self.radius[0]:
            ...
            for i in range(random.randint(self.radius[2], self.radius[3])):
                ...
                if(intersected):
                    ...
                    print ('intersection at X: %f | Y: %f | Z: %f' % (intersected.hitPoint.x,intersected.hitPoint.y,intersected.hitPoint.z))
                    ...
                    print('got the dag for the source object to use:')
                    print(intersected.dagMeshSourceObject)

                    if(sp3d_dbg): logDebugInfo('creating object from the dag')
                    print('creating object from the dag')
    ...
    def createObject(self,intersection):
        ...
        if (self.uiValues.instance):
            ...
            # comment by NCZ
            newObjectDAG = mc.duplicate(tempDAG[0], rc=1, rr=1, ic=self.uiValues.preserveConn)
        ...
        print('intersection.dagMeshSourceObject', intersection.dagMeshSourceObject)
        print('createObject', tempDAG)
        print('newObjectDAG', newObjectDAG)
