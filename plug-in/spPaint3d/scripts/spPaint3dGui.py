...
importlib.reload(spPaint3dContext)
...
class spPaint3dWin (object):
    ...
    def __init__(self):
        ...
        # Source Frame
        #----------------------
        icon_path = 'D:/Cling_toolbox/plug-in/spPaint3d/icons/'

        self.uiSourceFrame = mc.frameLayout(label='Brush Geometry', cll=True,
                                            collapseCommand=lambda: self.resizeWindow('collapse', 98),
                                            expandCommand=lambda: self.resizeWindow('expand', 98), mh=5, mw=5)
        ...
        self.uiSourceBtnAdd = mc.symbolButton(w=60, h=18, ann='Add selected object(s) to the list',
                                              image=icon_path + 'sp3dadd.xpm',
                                              command=lambda *args: self.uiListCallback("add", "uiSourceList"))
        self.uiSourceBtnRem = mc.symbolButton(w=60, h=18, ann='Remove selected object(s) from the list',
                                              image=icon_path + 'sp3drem.xpm',
                                              command=lambda *args: self.uiListCallback("rem", "uiSourceList"))
        self.uiSourceBtnClr = mc.symbolButton(w=60, h=18, ann='Clear the list', image=icon_path + 'sp3dclr.xpm',
                                              command=lambda *args: self.uiListCallback("clr", "uiSourceList"))

        mc.formLayout(self.uiSourceForm, edit=True, attachForm=[(self.uiSourceList, 'top', 0)],
        ...
        # Transform Setup
        #----------------------
        self.uiTransformFrame = mc.frameLayout(label='Transform Setup', cll=True, collapseCommand=lambda:self.resizeWindow('collapse', 177), expandCommand=lambda:self.resizeWindow('expand', 177), mh=5, mw=5)
        ...
        self.uiTargetFrame = mc.frameLayout(label='Target Surface(s)', cll=True,
                                            collapseCommand=lambda: self.resizeWindow('collapse', 98),
                                            expandCommand=lambda: self.resizeWindow('expand', 98), mh=5, mw=5,
        ...
        self.uiTargetBtnAdd = mc.symbolButton(w=60, h=18, ann='Add selected object(s) to the list',
                                              image=icon_path + 'sp3dadd.xpm',
                                              command=lambda *args: self.uiListCallback("add", "uiTargetList"))
        self.uiTargetBtnRem = mc.symbolButton(w=60, h=18, ann='Remove selected object(s) from the list',
                                              image=icon_path + 'sp3drem.xpm',
                                              command=lambda *args: self.uiListCallback("rem", "uiTargetList"))
        self.uiTargetBtnClr = mc.symbolButton(w=60, h=18, ann='Clear the list', image=icon_path + 'sp3dclr.xpm',
                                              command=lambda *args: self.uiListCallback("clr", "uiTargetList"))

        mc.formLayout(self.uiTargetForm, edit=True, attachForm=[(self.uiTargetList, 'top', 0)],
        ...
        # Paint Contexts
        # ----------------------
        self.uiPaintFrame = mc.frameLayout(label='Paint', cll=True,
        ...
        self.uiPaintDupSCB = mc.symbolCheckBox(w=52, h=18, ann='Duplicate: Instance or Copy',
                                               ofi=icon_path + 'sp3dduplicate.xpm',
                                               oni=icon_path + 'sp3dinstance.xpm',
                                               changeCommand=lambda *args: self.uiCheckBoxCallback("instance", args))
        self.uiPaintRandSCB = mc.symbolCheckBox(w=52, h=18, ann='Object distribution: Random or Sequential',
                                                ofi=icon_path + 'sp3dsequence.xpm', oni=icon_path + 'sp3drandom.xpm',
                                                changeCommand=lambda *args: self.uiCheckBoxCallback("random", args))
        self.uiPaintAlignSCB = mc.symbolCheckBox(w=100, h=18, ann='Align generated objects to the target surface',
                                                 ofi=icon_path + 'sp3dalignoff.xpm', oni=icon_path + 'sp3dalign.xpm',
                                                 changeCommand=lambda *args: self.uiCheckBoxCallback("align", args))
        self.uiPaintCtxBtn = mc.symbolButton(w=105, h=28, ann='Paint', image=icon_path + 'sp3dpaint.xpm',
                                             command=lambda *args: self.genericContextCallback("PaintCtx"))
        self.uiPlaceCtxBtn = mc.symbolButton(w=105, h=28, ann='Place', image=icon_path + 'sp3dplace.xpm',
    ...
    def genericContextCallback(self, *args):
        ...
        if(not sourcevalid):
            ...
            if (args[0] == 'PaintCtx'):
                ...
                print('genericContextCallback running ...')
    ...
    def setupWin(self, uiOptions):
        ...
        # Place Options
        #----------------------
        self.uiSetupPaintOptionsFrame = mc.frameLayout(label='Place Options', marginHeight=5, marginWidth=20)
        ...
        # Dev feature
        #----------------------
        self.uiSetupDevFrame = mc.frameLayout(label='Development Feature', marginHeight=5, marginWidth=20)
