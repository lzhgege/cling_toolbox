...
import random
import sys
# sys.path.append('Z:/Resources/Mist/All/TD_Data/Plug in of each link/Maya/SHD_plug')
...
import maya.cmds as mc
import hairTools
hairTools.randomizeHair(mc.ls(sl=True, fl=True, type='nurbsCurve', dag=True), [mc.floatSliderGrp("%s", q=True, value=True), mc.floatSliderGrp("%s", q=True, v=True), mc.floatSliderGrp("%s", q=True, v=True)])
